...
static void LCDWriteByte(uint8_t);
static void delay_ms(uint8_t d);
...
static void LCDWriteByte(uint8_t d)
{
	CLR_BIT(PORTB, 6);
	uint8_t i;
	for(i = 0; i < 8; i++)
